...
Com que frequência falham os IMs??
Quais as falhas e quail a distribuição de frequência das mesmas?

Relativamente à frequência, dizer que tal como dito no artigo do esa e no Induction Machine drive condition monitoring and diagnostic research, o estudo do EPRI mostra que a distribuição de frequência é a da figura \ref{fig:motorFailures} e \ref{fig:failures_frequency_epri}, mas esses valores variam de estudo para estudo. 
Então se variam, porque é que eu escolhi a do EPRI e não a dos IEEE \ref{fig:failures_frequency_IEEE_study} ou a do B\&K \ref{fig:failures_frequency_BK_study}?

The values of the figure \ref{fig:motorFailures} may vary by industry and application. For example, in the petroleum and chemical industry the bearings are responsible for 51\% of the failures.



\begin{figure}[htbp]
	\centering
	\includegraphics[height=1.8in]{motorFailures}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[height=3in]{Sources_im_failures}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[height=3in]{failures_frequency_BK_study}
	\caption{B\&K study of induction motor failures frequency}
	\label{fig:failures_frequency_BK_study}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[height=3in]{failures_frequency_epri}
	\caption{EPRI study of induction motor failures frequency}
	\label{fig:failures_frequency_epri}
\end{figure}

\begin{figure}[htbp]
	\centering
	\includegraphics[height=3in]{failures_frequency_IEEE_study}
	\caption{IEEE study of induction motor failures frequency}
	\label{fig:failures_frequency_IEEE_study}
\end{figure}