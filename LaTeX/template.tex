...
%%      - JoÃ£o LourenÃ§o <joao.lourenco@fct.unl.pt>
...
%%     and click in the â€œDonationâ€ link.
%%     I'll keep a list thanking to all the identified donors that identify
%%     themselves in the â€œ*Add special instructions to the seller:*â€ box.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% The default option marked with (*)
\documentclass[
  doctype=mscplan,          % phd(*), phdplan, phdprop, msc, mscplan, bsc
...
\prependtographicspath{{/Users/tds/thesisLatek/Chapters/Figures}}
...
% e.g.
% \majorfield[pt]={Engenharia BiomÃ©dica}
...
\title{Anomalies and Inter-Turn Short Circuit detection in Induction Motors using Machine Learning}
\subtitle{}

% Autor
% use [f] for female and [m] for male
\authorname[m]{Tiago dos Santos}{Tiago Santos}
\authordegree{Gradutate in Computer Science}
...
% use [f] for female and [m] for male
\adviser[m]{João Moura Pires}{Full Professor}{\\& NOVA University of Lisbon} 
...
% use [f] for female and [m] for male
\coadviser[m]{Carlos Damásio}{Associate\\& Professor}{Faculdade de Ciências e Tecnologia\\& da Universidade Nova de Lisboa}
% \coadviser[f]{[Nome da co-orientadora 2]}{[ProfÂª.\ Auxiliar]}{[Universidade Nova de Lisboa]}
...
\chapterfile{chap1_Intro}
\chapterfile{chap2_UndElectricMotors}
\chapterfile{chap4_AvailableData}
\chapterfile{chap3_RelatedWork}
