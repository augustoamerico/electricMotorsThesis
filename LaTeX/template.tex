...
\title{Electric Motors Predictive Maintenance using VueForge}
\subtitle{A Machine-Driven Big Data approach}
...
% use [f] for female and [m] for male
\adviser[f]{Jo�o Moura Pires}{Full Professor}{\\& NOVA University of Lisbon} 
