...
\title{On-line detection of Turn Insulation faults in Induction Motors through Electrical Signature Analysis}
\subtitle{}
...
% use [f] for female and [m] for male
\adviser[m]{João Moura Pires}{Assistant Professor}{\\& NOVA University of Lisbon} 
...
% use [f] for female and [m] for male
\coadviser[m]{Carlos Viegas Damásio}{Associate Professor}{\\& NOVA University of Lisbon}
